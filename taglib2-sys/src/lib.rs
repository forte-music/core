...
//    unsafe {
//        FileRef::new1(b"file.mp3\0".as_ptr() as FileName, read_audio_properties, audio_properties_style)
//    }
//}


extern "C" {
    pub fn hello(filename: *const std::os::raw::c_char) -> *const std::os::raw::c_char;
}
